...
public interface DirectoryTraverse
{
     ...
     * @see DirectoryTraverse#getDirectoryInfo(Path, int, Predicate)
     */
    DirectoryDto getDirectoryInfo(Path rootDir, BiPredicate<Integer, String> namePredicate) throws IOException;
     ...
     * @throws IOException
     */
    DirectoryDto getDirectoryInfo(Path rootDir, int maxDepth, BiPredicate<Integer, String> namePredicate) throws IOException;
