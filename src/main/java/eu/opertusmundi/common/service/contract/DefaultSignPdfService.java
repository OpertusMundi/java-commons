...
{   
    private static Logger logger = LoggerFactory.getLogger(DefaultSignPdfService.class);
    ...
    public void sign(PDDocument document, OutputStream output)
        throws Exception
    {
        SignPdf signpdf = new SignPdf(keystore, keyAlias, keyPassword.toCharArray());
    ...
    public void signWithVisibleSignature(PDDocument document, OutputStream output)
        throws Exception
    {
        SignPdfWithVisibleSignature signpdf = 
