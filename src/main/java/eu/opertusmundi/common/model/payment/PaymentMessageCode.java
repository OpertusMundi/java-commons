...
public enum PaymentMessageCode implements MessageCode {
    ...
    SUBSCRIPTION_BILLING_NOT_FOUND,
    SUBSCRIPTION_BILLING_INVALID_STATUS,
    SUBSCRIPTION_BILLING_ACCESS_DENIED,
    SUBSCRIPTION_BILLING_PAYOFF_ERROR,
    SUBSCRIPTION_BILLING_INVALID_ITEM_TYPE,
    ;
