...
public class JwtUtils {
    ...
    public String createToken(AccountDto account) throws Exception {
        return this.createToken(null, account);
    }

    public String createToken(String alias, AccountDto account) throws Exception {
    ...
    public String createToken(
        ...
        if (StringUtils.isBlank(alias)) {
            ...
            final byte[] signingKey = Base64.getDecoder().decode(this.jwtSecret);
